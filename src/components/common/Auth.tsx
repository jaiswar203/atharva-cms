...
import { setUser } from '@/redux/slice/app'
            ...
            <Card className="mx-auto max-w-sm w-full ce-auth">
                <CardHeader>
                    <div className="flex items-center">
                        <Image src={"/images/icon.png"} width={60} height={60} className=" mr-4" alt="CL" />
                        <CardTitle className="text-xl">{isLogin ? "Login" : "Welcome"} to AGI Admin Dashboard</CardTitle>
                    </div>
